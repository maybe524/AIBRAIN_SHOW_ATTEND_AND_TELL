...
deploy = '/mnt/hgfs/I/ebook/PictureAnaly/show_attend_and_tell/caffe-master/models/bvlc_reference_caffenet/deploy.prototxt'
model = '/mnt/hgfs/I/ebook/PictureAnaly/show_attend_and_tell/bvlc_reference_caffenet.caffemodel'
# mean = '/home/taeksoo/Package/caffe/python/caffe/imagenet/ilsvrc_2012_mean.npy'
mean = '/mnt/hgfs/I/ebook/PictureAnaly/show_attend_and_tell/caffe-master/python/caffe/imagenet/ilsvrc_2012_mean.npy'
...
class CNN(object):
    ...
    def get_features(self, image_list, layers='fc7', layer_sizes=[4096]):
        ...
        print("get_features(): len(image_list)] + layer_sizes = ", [len(image_list)] + layer_sizes)
